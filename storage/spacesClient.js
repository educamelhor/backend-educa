...
/**
 * DigitalOcean Spaces (S3-compatible) — Client oficial (AWS SDK v3)
 *
 * Regras:
 * - Nunca logar segredos (key/secret).
 * - Falhar cedo se ENV obrigatórias estiverem ausentes.
 * - Endpoint é obrigatório para Spaces (ex.: https://nyc3.digitaloceanspaces.com)
 */
