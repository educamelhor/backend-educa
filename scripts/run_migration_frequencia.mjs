// scripts/run_migration_frequencia.mjs
// Executa a migration do módulo FREQUÊNCIA de forma idempotente (IF NOT EXISTS)
// Uso: node scripts/run_migration_frequencia.mjs
...
async function main() {
  console.log("🚀 Iniciando migration FREQUÊNCIA...\n");
  ...
  try {
    ...
    console.log("\n✅ Migration FREQUÊNCIA concluída com sucesso!");
  } catch (err) {
